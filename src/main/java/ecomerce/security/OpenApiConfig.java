...
public class OpenApiConfig {
    ...
    public OpenAPI openApi(){
        ...
        contact.setUrl("https://amadoDeveloper/contacto");
        ...
        Info info = new Info()
                .title("Documentación de la API E-Comerce")
                .version("1.0")
                .contact(contact)
                .description("Esta API expone los endpoints para usar la API E-Comerce")
